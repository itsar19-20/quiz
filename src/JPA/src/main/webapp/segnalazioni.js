        ...
        .done((segn) => {
            ...
            listSegn.forEach(s => {
                ...
                if ((s.risolta)) {
                    ...
                    if (s.tipo == "generica") {
                        if (s.consegna == null && !s.inLavorazione) {
                            nonRisList[w] = s
                            w++;
                        } else if(s.consegna != null) {

                            if (s.consegna.username == utente.username) {
                                console.log("Test " + s.consegna.username + f);
                                ConsegnaList[f] = s
                                f++;
                            }
            ...
            console.log(ConsegnaList.length);
            //tabella consegna
            var i = 0;
            ConsegnaList.forEach(u => {
